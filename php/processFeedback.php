...
$messageToClient =
    ...
    "The following message was received from you by Sock Exchange:\r\n\r\n".
    $messageToBusiness.
    "------------------------\r\nThank you for your Feedback :D\r\n" .
    "The Sock Exchange Team\r\n------------------------\r\n";
if ($_POST['mail list'])
...
$headerToClient = "From: kvonderw@uci.edu\r\n";
...
$display = str_replace("\r\n", "<br />\r\n", $messageToClient);
$display =
    "<html><head><title>Feedback</title></head><body><tt>".
    $display.
    "</tt></body></html>";
echo $display;
